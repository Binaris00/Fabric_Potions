...
public class Bleed_Potions extends Potion {
    ...
    public Bleed_Potions(){
        if(Fabric_Potions_PotionsConfig.CONFIG.getOrDefault("bleed_potion.enable", true)){
        ...
        if(Fabric_Potions_PotionsConfig.CONFIG.getOrDefault("long_bleed_potion.enable", true)){
        ...
        if(Fabric_Potions_PotionsConfig.CONFIG.getOrDefault("strong_bleed_potion.enable", true)){
            STRONG_BLEED = Registry.register(Registries.POTION, new Identifier(Fabric_Potions.MOD_ID, "strong_bleed_potion"), new Potion(new StatusEffectInstance(Fabric_PotionsEffects.BLEED, 620, 1)));
