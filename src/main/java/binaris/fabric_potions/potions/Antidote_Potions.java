...
import binaris.fabric_potions.config.Fabric_Potions_Potions;
...
public class Antidote_Potions extends Potion{
    ...
    public Antidote_Potions(){
        if(Fabric_Potions_Potions.CONFIG.getOrDefault("antidote_potion.enable", true)){
        ...
        if(Fabric_Potions_Potions.CONFIG.getOrDefault("long_antidote_potion.enable", true)){
