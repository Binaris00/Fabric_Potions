...
public class Trueshot_Potions extends Potion {
    ...
    public Trueshot_Potions(){
        if(Fabric_Potions_PotionsConfig.CONFIG.getOrDefault("trueshot_potion.enable", true)){
        ...
        if(Fabric_Potions_PotionsConfig.CONFIG.getOrDefault("long_trueshot_potion.enable", true)){
        ...
        if(Fabric_Potions_PotionsConfig.CONFIG.getOrDefault("strong_trueshot.enable", true)){
