...
public class Burst extends StatusEffect {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        entity.getWorld().addParticle(ParticleTypes.EXPLOSION, entity.getX(), entity.getY(), entity.getZ(), 1.0, 0.0, 0.0);
    ...
    public void applyInstantEffect(@Nullable Entity source, @Nullable Entity attacker, LivingEntity target, int amplifier, double proximity) {
        source.playSound(SoundEvents.ENTITY_GENERIC_EXPLODE, 1.0F, 1.0F);
        source.getWorld().addParticle(ParticleTypes.EXPLOSION, source.getX(), source.getY(), source.getZ(), 1.0, 0.0, 0.0);
